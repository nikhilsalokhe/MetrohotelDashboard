                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
                            <div class="breadcomb-report">
                                <a class="btn btn-success" href="{{action('Voucher\VoucherNameController@create')}}" role="button">
                            ...
                            <tbody>
                                @foreach($voucherNames as $voucher)
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <a href="{{action('Voucher\VoucherNameController@edit', $voucher['id'])}}" class="btn btn-warning">Update Status</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
