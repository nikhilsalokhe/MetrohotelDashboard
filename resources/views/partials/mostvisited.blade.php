...
@section('content')
    ...
    <div class="card m-2 border">
        <div class="card-header" style="background-color: rgb(215, 221, 228)">
                @include('backbutton')
            <h2 class="text-center"> Most Visited Customers</h2>
            <h3 class="text-center">{{ $mostcount }}</h3>
            <div class="container">
                <form action="{{ url('findMostCustomer') }}" method="GET" role="search">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const dataTable = $('#data-table-basic')
                .DataTable(); // Replace 'yourTableId' with the actual ID of your DataTable
